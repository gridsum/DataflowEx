...
namespace Gridsum.DataflowEx.Databases
{
    ...
    {
        private readonly TargetTable m_targetTable;
        ...
        protected async virtual Task DumpToDB(IEnumerable<T> data, TargetTable targetTable)
        {
        ...
        protected virtual async Task OnPostBulkInsert(SqlConnection sqlConnection, TargetTable target, IEnumerable<T> insertedData)
        {
        ...
        protected virtual IEnumerable<T> PreprocessBatch(T[] array)
        {
            return array;
        }
    }
    ...
    public delegate Task PostBulkInsertDelegate<in T>(SqlConnection connection, TargetTable target, IEnumerable<T> insertedData);
}
